...
def login():
    ...
    st.markdown("<h6> Please enter your credentials to access the Portal.</h6>", unsafe_allow_html=True)
...
def dashboard():
    ...
    if menu_option == "All Startups":
        ...
        st.write("All Startups Dashboard Content")
    ...
    # Startup Specific Insights
        ...
        if not startups_data.empty and not profiles_data.empty:
            ...
            with col1:
                st.markdown(
                    ...
                    f"<div class='metric-value' style='font-size: 30px;'>{filtered_data['industry'].iloc[0]}</div>"
                    "</div>",
                    unsafe_allow_html=True,
                )
        ...
        st.write("Startup-Specific Insights Dashboard Content")
